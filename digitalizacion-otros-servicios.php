...
<title>morés - Otros servicios de digitalización </title>
<?php
  // $h1text : variable para fijar el H1 en cada pagina para hacerlo único y aprovechar mejor el SEO
  $h1text = "Otros servicios de digitalización - morés";
 ?>
...
<p>
También le ofrecemos una amplia gama de soluciones en materia de grabación y digitalización multisoporte:
</p>
<ul>
